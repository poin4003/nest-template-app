...
export function getFileFromName(
	fileName: string,
	subFolder: string = '',
): Express.Multer.File {
...
export function getImageFromAsset(fileName: string): Express.Multer.File {
	const rootDir = process.cwd();

	const filePath = path.join(rootDir, 'src', 'assets', 'images', fileName);
